        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="about.php"><i class="icon-info" style="font-size: 20px;"></i><span style="font-size: 18px;margin-left: 10px;">Tentang warungku</span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Tentang warungku</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="../assets/img/kasir.jpg?h=a0a7d00bcd8e4f84f4d8ce636a8f94d4" width="160" height="160"></div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">HelmiMuhammadHatta</h4>
                                            <h6 class="text-muted card-subtitle mb-2" style="margin-bottom: 0px;">Programmer</h6>
                                            <p class="card-text">Contact us at&nbsp;</p><a class="card-link" href="https://github.com/HelmiMuhammadHatta">Github</a></div>
                                    </div>
